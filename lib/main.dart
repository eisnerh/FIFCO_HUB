...
class _MyAppState extends State<MyApp> {
  // DatabaseHelper se usa para la política de seguridad
  // final DatabaseHelper _dbHelper = DatabaseHelper();

  // Política de Seguridad de la Empresa:
  // - La limpieza de credenciales se maneja manualmente
  // - Botón "Cerrar aplicación" limpia todas las credenciales
  ...
  // Nota: La limpieza de credenciales ahora se maneja manualmente
  // a través del botón "Cerrar aplicación" en el HomeScreen
